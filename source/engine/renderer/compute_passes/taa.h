...
namespace engine{
	...
	class TAAPass: public ComputePass
	{
	public:
		TAAPass(
	...
	public:
		std::vector<VkPipeline> m_pipelinesSharpen = {};
		std::vector<VkPipelineLayout> m_pipelineLayoutsSharpen = {};
		std::vector<VulkanDescriptorSetReference> m_descriptorSetsSharpen = {};
		std::vector<VulkanDescriptorLayoutReference> m_descriptorSetLayoutsSharpen = {};
	};
